...
Existem os **contratos** (`Relation`, `RelationEvidence` e seus tipos de apoio), a **taxonomia de predicados** versionada e as **convenções de frame** declaradas pela execução. Candidatos, avaliadores geométricos, política de decisão, artifact e avaliação chegam nas demais issues da milestone "Spatial Relations" (#142 a #148).
...
- `contextmap.geometric_mapping`: `GeometryReference`, `GeometryId` e `MapId`, apenas como identidades.
