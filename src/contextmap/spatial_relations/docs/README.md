...
- `link_statements()`, `UpstreamRelationStatement`, `LinkedStatements`, `UnlinkedStatement`, `LinkFailure` — o vínculo de afirmações upstream às entidades resolvidas pelas observações espaciais da evidência delas, sem palpite.
