"""Real cross-stage lineage/coordinate/traceability/physical-identity check (issue #178)
over the real corridor-02 canonical run (issue #177) -- the first time check_cross_stage()
has been run against real artifacts rather than the synthetic CI fixture.
"""
...
TRAJECTORY_DIR = WORKSPACE / "e2e-real/run-0001/state_estimation"
GEOMETRY_DIR = WORKSPACE / "e2e-real/run-0001/geometric_mapping"
PERCEPTION_DIR = WORKSPACE / "e2e-real/visual_perception/workspace/corridor-02/run-0001/visual_perception"
ASSOCIATION_DIR = WORKSPACE / "e2e-real/run-0001/sensor_association"
FUSION_DIR = WORKSPACE / "e2e-real/run-0001/semantic_fusion"
MAPPING_DIR = WORKSPACE / "e2e-real/run-0001/semantic_mapping"
RESOLUTION_DIR = WORKSPACE / "e2e-real/run-0001/entity_resolution"
RELATIONS_DIR = WORKSPACE / "e2e-real/run-0001/spatial_relations"
CONTEXT_MAP_DIR = WORKSPACE / "e2e-real/run-0001/context_map"
...
def main() -> None:
    ...
    if not report.findings:
        print("NO FINDINGS -- every checked boundary held.")
