"""Real sensor_association over run-0003's trajectory/geometry + the reused real perception run.
...
OUTPUT_DIR = WORKSPACE / "e2e-real/run-0003/sensor_association"
        ...
        inputs={
            ...
            "trajectory": (
                ArtifactRef(
                    ...
                    location="e2e-real/run-0003/state_estimation",
                ),
            ),
            "geometry": (
                ArtifactRef(
