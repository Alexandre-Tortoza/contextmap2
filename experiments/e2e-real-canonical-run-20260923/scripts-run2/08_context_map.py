"""Real context_map assembly: the regenerated ContextMapArtifact for corridor-02 (run-0002).
...
ENTITY_RESOLUTION_ARTIFACT_ID = "bcd9cb4c966ae41693efb3cf0d6a8e88"
SPATIAL_RELATIONS_ARTIFACT_ID = "079c8cbdeb4171ff2841e00c45fea002"
OUTPUT_DIR = WORKSPACE / "e2e-real/run-0002/context_map"
...
def main() -> None:
        ...
        inputs={
            ...
            "entities": (
                ArtifactRef(
                    ...
                    location="e2e-real/run-0002/entity_resolution",
                ),
            ),
            "relations": (
                ArtifactRef(
                    ...
                    location="e2e-real/run-0002/spatial_relations",
                ),
            ),
        },
        components={},
    ...
    executor = ContextMapExecutor(
        up_axis=AxisDirection.POSITIVE_Z, code_version="e2e-real-canonical-run-20260924"
    )
