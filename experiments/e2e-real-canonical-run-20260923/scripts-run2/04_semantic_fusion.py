"""Real semantic_fusion over run-0002's association + the reused real perception + geometry."""
...
SENSOR_ASSOCIATION_ARTIFACT_ID = "d52df690e80bc18041c07389d2e9037a"
PERCEPTION_LOCATION = "e2e-real/visual_perception/workspace/corridor-02/run-0001/visual_perception"
OUTPUT_DIR = WORKSPACE / "e2e-real/run-0002/semantic_fusion"
        ...
        inputs={
            ...
            "association": (
                ArtifactRef(
                    ...
                    location="e2e-real/run-0002/sensor_association",
                ),
            ),
            "perception": (
                ArtifactRef(
