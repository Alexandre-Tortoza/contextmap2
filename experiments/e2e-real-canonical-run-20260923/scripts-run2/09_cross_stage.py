"""Real cross-stage check (issue #178) over the regenerated run-0002 chain (PR #438 review).
...
TRAJECTORY_DIR = WORKSPACE / "e2e-real/run-0002/state_estimation"
GEOMETRY_DIR = WORKSPACE / "e2e-real/run-0002/geometric_mapping"
PERCEPTION_DIR = WORKSPACE / "e2e-real/visual_perception/workspace/corridor-02/run-0001/visual_perception"
ASSOCIATION_DIR = WORKSPACE / "e2e-real/run-0002/sensor_association"
FUSION_DIR = WORKSPACE / "e2e-real/run-0002/semantic_fusion"
MAPPING_DIR = WORKSPACE / "e2e-real/run-0002/semantic_mapping"
RESOLUTION_DIR = WORKSPACE / "e2e-real/run-0002/entity_resolution"
RELATIONS_DIR = WORKSPACE / "e2e-real/run-0002/spatial_relations"
CONTEXT_MAP_DIR = WORKSPACE / "e2e-real/run-0002/context_map"
