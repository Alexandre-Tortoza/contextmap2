...
def main() -> None:
    ...
    ok = compare(
        ...
        workspace / "e2e-real/run-0002/geometric_mapping",
        workspace / "corridor-02-repro-check/run-0004/context_map",
        workspace / "corridor-02-repro-check/run-0003/geometric_mapping",
    )
    if not ok:
