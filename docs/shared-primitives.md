...
- **quem usa:** `state_estimation`, `geometric_mapping` e `sensor_association` agora; `point_representation` e `semantic_fusion` nas milestones seguintes, todos com a mesma regra de `ARTIFACTS.md`;
